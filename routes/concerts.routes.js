...
router.delete('/concerts/:id', ConcertController.delConcert);
...
router.get('/concerts/price/:price_min/:price_max', ConcertController.sortByPrice);

router.get('/concerts/day/:day', ConcertController.sortByDay);
